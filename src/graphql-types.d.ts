...
export enum FileFieldsEnum {
  ...
  ChildOfferCraftLabel = 'childOffer___craft___label',
  ChildOfferCraftProducts = 'childOffer___craft___products',
  ChildOfferCraftProductsId = 'childOffer___craft___products___id',
  ChildOfferCraftProductsLabel = 'childOffer___craft___products___label',
  ChildOfferCraftProductsImages = 'childOffer___craft___products___images',
  ChildOfferAssortmentLabel = 'childOffer___assortment___label',
  ChildOfferAssortmentProducts = 'childOffer___assortment___products',
  ChildOfferAssortmentProductsId = 'childOffer___assortment___products___id',
  ChildOfferAssortmentProductsLabel = 'childOffer___assortment___products___label',
  ChildOfferAssortmentProductsImages = 'childOffer___assortment___products___images',
...
export type Offer = Node & {
  ...
  title: Maybe<Scalars['String']>;
  description: Maybe<Scalars['String']>;
  craft: Maybe<OfferCraft>;
  assortment: Maybe<OfferAssortment>;
};

export type OfferAssortment = {
...
export enum OfferFieldsEnum {
  ...
  Title = 'title',
  Description = 'description',
  CraftLabel = 'craft___label',
  CraftProducts = 'craft___products',
  CraftProductsId = 'craft___products___id',
  CraftProductsLabel = 'craft___products___label',
  CraftProductsImages = 'craft___products___images',
  CraftProductsImagesId = 'craft___products___images___id',
  CraftProductsImagesImage = 'craft___products___images___image',
  AssortmentLabel = 'assortment___label',
  AssortmentProducts = 'assortment___products',
  AssortmentProductsId = 'assortment___products___id',
  AssortmentProductsLabel = 'assortment___products___label',
  AssortmentProductsImages = 'assortment___products___images',
  AssortmentProductsImagesId = 'assortment___products___images___id',
  AssortmentProductsImagesImage = 'assortment___products___images___image'
}
...
export type OfferFilterInput = {
  ...
  title: Maybe<StringQueryOperatorInput>;
  description: Maybe<StringQueryOperatorInput>;
  craft: Maybe<OfferCraftFilterInput>;
  assortment: Maybe<OfferAssortmentFilterInput>;
};
  ...
  & { offer: Maybe<(
    ...
    & { craft: Maybe<(
      ...
      & { products: Maybe<Array<Maybe<(
        { __typename?: 'offerCraftProducts' }
        & Pick<OfferCraftProducts, 'id' | 'label'>
      ...
      & { products: Maybe<Array<Maybe<(
        { __typename?: 'offerAssortmentProducts' }
        & Pick<OfferAssortmentProducts, 'id' | 'label'>
        & { images: Maybe<Array<Maybe<(
          { __typename?: 'offerAssortmentProductsImages' }
